...
export const Testimonials = () => {
  ...
  return (
    <section 
      id="testimonials"
      className="py-24 md:py-32 px-4 md:px-8 lg:px-16 relative overflow-hidden bg-gradient-to-b from-[#F6F3FF] via-[#EDE6FF] via-[#D8C8FF] to-white transition-all duration-500"
    >
      {/* Soft Glow Effect */}
