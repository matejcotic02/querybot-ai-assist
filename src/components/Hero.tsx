...
export const Hero = () => {
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden">
      {/* Navigation Bar */}
      <nav className="fixed top-0 left-0 right-0 z-50 w-full bg-white/80 dark:bg-background/80 backdrop-blur-md border-b border-border/50 px-6 md:px-12 lg:px-16">
